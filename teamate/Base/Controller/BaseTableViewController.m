...
- (UITableViewCell *)nh_cellAtIndexPath:(NSIndexPath *)indexPath { return [BaseTableViewCell cellWithTableView:self.tableView]; }
...
- (UIView *)nh_headerAtSection:(NSInteger)section { return [BaseTableHeaderFooterView headerFooterViewWithTableView:self.tableView]; }

- (UIView *)nh_footerAtSection:(NSInteger)section { return [BaseTableHeaderFooterView headerFooterViewWithTableView:self.tableView]; }

- (CGFloat)nh_sectionHeaderHeightAtSection:(NSInteger)section { return 0.0; }

- (CGFloat)nh_sectionFooterHeightAtSection:(NSInteger)section { return 0.0; }
